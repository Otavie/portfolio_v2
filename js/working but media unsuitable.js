const tl = gsap.timeline({defaults: {stagger:1} })
    .fromTo('.sun', {delay: 0, opacity:1, duration:1, x:'-55px', y:'95px'}, {opacity:1, duration:5, x:'-55px', y:'95px', ease: "none"}, 0)
    ...
    .addPause(">", wait)
    .fromTo('.vuejs, .javascript, .git, .python, .reactnative, .html5, .css3, .github', {opacity:1, duration:2}, {opacity:0, duration:5}, 25)
    .fromTo('.sun', {opacity:1, duration:20, x:'-55px', y:'95px'}, {opacity:1, boxShadow: "-80px 100px 500px rgba(255, 0, 0, 0.955);", duration:20, x:'75px', y:'0px', ease: "one"}, 20)
    ...
    .addPause(">", wait)
    .fromTo('.sun', { delay:1, opacity:1, boxShadow: "-80px 100px 500px rgba(255, 0, 0, 0.955);", duration:20, x:'75px', y:'0px'}, {opacity:1, duration:20, x:'-55px', y:'95px', ease: "none"}, 50)    
    .fromTo('.landing', { boxShadow: "inset 0 0 0 1000px rgba(0,0,0,1)"}, {duration:20, boxShadow: "inset 0 0 0 1000px rgba(0,0,0,0)", ease: "none"}, 45)
    .set('.vuejs, .javascript, .git, .python, .reactnative, .html5, .css3, .github', {opacity:1, duration:2})
    .fromTo('.writeup h1', {delay: 0, opacity:1, scale:1}, {delay: 0, duration:4, opacity: 0, scale:0, ease: "ease"}, 50)
...
te.fromTo('.github', {duration: 5, x: '-40vw', y:'-40vh', scaleX:-1}, {duration: 5, y:'40vh', x: '40vw', scaleX:1}, 0)
